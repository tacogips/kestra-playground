...
verify_gce_compose() {
  ...
  verify_environment gce-compose "https://gce-compose.tacoserve.online"
}

verify_gce_container() {
  configure_gce_auth kestra-cluster-dev
  verify_environment gce-container "https://gce-container.tacoserve.online"
}

verify_k8s() {
  configure_k8s_auth
  verify_environment k8s "https://k8s.tacoserve.online"
}
